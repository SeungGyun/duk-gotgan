...
export function Dashboard({
  ...
  // 상한을 바꾸는 것은 **관리자만** 입니다. 자물쇠가 셋입니다 — 이 화면 자체가
  // 관리자 전용 라우트이고(App.tsx), 여기서 편집 UI 를 가리고, 서버가 403 으로
 ...
 *  이어집니다.
 *
 *  **바꾸는 것은 관리자만입니다.** 눌러도 안 되는 버튼을 보여 주면 "왜 나만
 *  안 되지"가 되므로, 관리자가 아니면 편집 손잡이 없이 숫자만 보여 줍니다. */
